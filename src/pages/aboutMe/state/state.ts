...
export const generalInformation: GeneralInformationType = {
    'russian': [
        "Имею отношение и плотно взаимодействую в сфере культурных искусств на протяжении многих лет.",
        "Сочитаю в себе безусловную любовь к историй искусства и классического портрета дополняя это художнственным чутьём и бескомпромисным вниманием к деталям, проявляя лучшие черты портретируемого.",
    ...
    'england': [
        "I have been involved and closely interacted in the field of cultural arts for many years.",
